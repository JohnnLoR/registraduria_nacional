...
import asyncTeam.pruebaSecurity.pruebaSecurity.repositorios.RepositorioUsuario;
...
public class ControladorUsuario {
    ...
    /**
     * Función que añada el rol a un usuario
     */
    @PutMapping("{id_usuario}/rol/{id_rol}")
    public Usuario asignarRolUsuario(@PathVariable String id_usuario, @PathVariable String id_rol) {
